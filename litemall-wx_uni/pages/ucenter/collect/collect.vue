...
<view class="container">
  ...
  <view class="collect-list" v-else>
    <view :data-index="index" :key="id" @tap="openGoods" @touchend="touchEnd" @touchstart="touchStart" class="item" v-for="(item, id) in collectList">
...
global['__wxRoute'] = 'pages/ucenter/collect/collect';
...
export default global['__wxComponents']['pages/ucenter/collect/collect'];
</script>
<style>
@import "./collect.css";
</style>