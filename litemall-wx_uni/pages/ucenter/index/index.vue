    ...
    <view class="container">
        ...
        <view class="user_area">
            ...
            <view class="user_column">
                <view @tap="goOrderIndex" class="user_column_item" data-index="1"
                ...
                <view @tap="goOrderIndex" class="user_column_item" data-index="2"
                      data-route="/pages/ucenter/order/order">
                ...
                <view @tap="goOrderIndex" class="user_column_item" data-index="3"
                      data-route="/pages/ucenter/order/order">
                ...
                <view @tap="goOrderIndex" class="user_column_item" data-index="4"
                      data-route="/pages/ucenter/order/order">
        ...
        <view class="user_row">
            <view class="user_row_left">我要赚钱</view>
        </view>
        <view class="user_column">
            <view @tap="goQcode" class="user_column_item">
                <image class="user_column_item_image" src="../../../static/images/qcode.png"></image>
                <view class="user_column_item_text">推广二维码</view>
            </view>
            <view class="user_column_item">
                <image class="user_column_item_image"></image>
                <view class="user_column_item_text"></view>
            </view>
            <view @tap="goLink" class="user_column_item">
                <image class="user_column_item_image" src="../../../static/images/link.png"></image>
                <view class="user_column_item_text">推广链接</view>
            </view>
            <view class="user_column_item">
                <image class="user_column_item_image"></image>
                <view class="user_column_item_text"></view>
            </view>
            <view @tap="goCompany" class="user_column_item">
                <image class="user_column_item_image" src="../../../static/images/company.png"></image>
                <view class="user_column_item_text">合作伙伴</view>
            </view>
        </view>
        <view class="separate">
        </view>
