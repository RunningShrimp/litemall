<template>
    <view class="container">
        ...
        <view class="fb-body">
            <textarea :value="content" @input="contentInput" auto-focus="true" class="content" maxlength="500"
                      placeholder="对我们网站、商品、服务，你还有什么建议吗？你还希望在商城上买到什么？请告诉我们..."></textarea>
        ...
        <view class="fb-mobile">
            ...
            <view class="mobile-box">
                <input :value="mobile" @input="mobileInput" class="mobile" maxlength="11" placeholder="方便我们与你联系"
                       type="number"></input>
