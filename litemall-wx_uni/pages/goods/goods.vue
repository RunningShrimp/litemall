<template>
    <view>
        <view class="container">
            <swiper autoplay="true" class="goodsimgs" duration="1000" indicator-dots="true"
                    interval="3000">
            ...
            <view :hidden="!openShare" class="share-pop-box">
                <view class="share-pop">
                    ...
                    <view class="share-info">
                        ...
                        <button @opensetting="handleSetting" class="savesharebtn" open-type="openSetting"
            ...
            <view class="attr-pop">
                ...
                <view class="spec-con">
                    <view :key="name" class="spec-item" v-for="(item, name) in specificationList">
                        ...
                        <view class="values">
                            <view :class="'value ' + (vitem.checked ? 'selected' : '')" :data-name="vitem.specification"
                                  :data-value-id="vitem.id" :key="id" @tap="clickSkuValue"
                                  v-for="(vitem, id) in item.valueList">{{vitem.value}}
                            </view>
                        </view>
                    </view>
                    ...
                    <view class="spec-item" v-if="groupon.length > 0">
                        ...
                        <view class="values">
                            <view :class="'value ' + (vitem.checked ? 'selected' : '')" :data-name="vitem.specification"
                                  :data-value-id="vitem.id" :key="index" @tap="clickGroupon"
                                  v-for="(vitem, index) in groupon">￥{{vitem.discount}} ({{vitem.discountMember}}人)
                            </view>
                        </view>
                    </view>
