<template>
    <view class="comments">
        ...
        <view class="b">
            <view :key="id" class="item" v-for="(item, id) in comments">
                <view class="info">
                    <view class="user">
                ...
                <view class="imgs" v-if="item.picList.length > 0">
                    <image :key="index" :src="pitem" class="img" v-for="(pitem, index) in item.picList"></image>
                </view>
            </view>
...
<script>
    ...
    global['__wxRoute'] = 'pages/topicComment/topicComment';
    var app = getApp();
    ...
    export default global['__wxComponents']['pages/topicComment/topicComment'];
</script>
<style>
