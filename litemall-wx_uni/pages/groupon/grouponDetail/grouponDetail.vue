...
<view class="container">
  <view class="progress">
    <view class="item-a">
      <van-steps :active="active" :active-color="activeColor" :active-icon="activeIcon" :steps="steps"></van-steps>
    </view>
    <view class="item-c" v-if="groupon.status === 1">
      <view class="l">开团还缺<van-tag type="danger">{{rules.discountMember - joiners.length}}</van-tag>人</view>
      <view class="r">
