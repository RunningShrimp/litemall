    ...
    <view class="cart-view" v-else>
      <view class="list">
        <view class="group-item">
          <view class="goods">
            <view :class="'item ' + (isEditCart ? 'edit' : '')" :key="id" v-for="(item, id) in cartGoods">
              <van-checkbox :data-item-index="index" :value="item.checked" @change="checkedItem"></van-checkbox>
      ...
      <view class="cart-bottom">
        ...
        <view class="action_btn_area">
          ...
          <view @tap="deleteCart" class="delete" v-if="isEditCart">删除({{cartTotal.checkedGoodsCount}})</view>
