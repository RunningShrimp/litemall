        ...
        <view class="post-comment">
            ...
            <view class="rater">
                ...
                <block :key="index" v-for="(item, index) in stars">
                    <van-icon :data-star="item" @tap="selectRater" color="#ab956d" name="star"
                              v-if="item < star"></van-icon>
                    <van-icon :data-star="item" @tap="selectRater" name="star-o" v-else></van-icon>
                </block>
                <text class="rater-desc">{{starText}}</text>
            </view>
            <view class="input-box">
                <textarea @input="bindInputValue" class="content" focus="true" maxlength="140"
                          placeholder="留言经过筛选后，对所有人可见"></textarea>
...
<script>
    ...
    global['__wxRoute'] = 'pages/topicCommentPost/topicCommentPost';
    ...
    export default global['__wxComponents']['pages/topicCommentPost/topicCommentPost'];
</script>
<style>
