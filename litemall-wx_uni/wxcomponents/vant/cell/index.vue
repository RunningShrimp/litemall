<template>
<uni-shadow-root class="vant-cell-index"><view :class="'custom-class '+(utils.bem('cell', [size, { center, required, borderless: !border, clickable: isLink || clickable }]))" :style="customStyle" @click="onClick" hover-class="van-cell--hover hover-class" hover-stay-time="70">
