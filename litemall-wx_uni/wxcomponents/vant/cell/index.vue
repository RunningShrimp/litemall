<template>
    <uni-shadow-root class="vant-cell-index">
        <view :class="'custom-class '+(utils.bem('cell', [size, { center, required, borderless: !border, clickable: isLink || clickable }]))"
              :style="customStyle" @click="onClick" hover-class="van-cell--hover hover-class" hover-stay-time="70">
            <van-icon :name="icon" class="van-cell__left-icon-wrap" custom-class="van-cell__left-icon"
                      v-if="icon"></van-icon>
