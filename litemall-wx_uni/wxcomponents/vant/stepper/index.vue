...
<uni-shadow-root class="vant-stepper-index"><view class="van-stepper custom-class">
  <view :class="'minus-class '+(utils.bem('stepper__minus', { disabled: disabled || disableMinus || value <= min }))" :style="buttonStyle" @click="onTap" @touchend="onTouchEnd" @touchstart="onTouchStart" data-type="minus" hover-class="van-stepper__minus--hover" hover-stay-time="70" v-if="showMinus"></view>
  ...
  <view :class="'plus-class '+(utils.bem('stepper__plus', { disabled: disabled || disablePlus || value >= max }))" :style="buttonStyle" @click="onTap" @touchend="onTouchEnd" @touchstart="onTouchStart" data-type="plus" hover-class="van-stepper__plus--hover" hover-stay-time="70" v-if="showPlus"></view>
