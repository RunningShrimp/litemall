<template>
    <uni-shadow-root class="vant-dialog-index">
        <van-popup :close-on-click-overlay="closeOnClickOverlay" :custom-class="'van-dialog '+(className)"
                   :custom-style="'width: '+(utils.addUnit(width))+';'+(customStyle)" :overlay="overlay"
                   :overlay-style="overlayStyle" :show="show" :transition="transition" :z-index="zIndex"
            ...
            <view class="van-hairline--top van-dialog__footer">
                <van-button :custom-style="'color: '+(cancelButtonColor)" :loading="loading.cancel" @click="onCancel"
                            ...
                            size="large" v-if="showCancelButton">
                    {{ cancelButtonText }}
                </van-button>
