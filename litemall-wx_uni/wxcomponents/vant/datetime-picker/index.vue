<template>
<uni-shadow-root class="vant-datetime-picker-index"><van-picker :cancel-button-text="cancelButtonText" :columns="columns" :confirm-button-text="confirmButtonText" :item-height="itemHeight" :show-toolbar="showToolbar" :title="title" :visible-item-count="visibleItemCount" @cancel="onCancel" @change="onChange" @confirm="onConfirm" active-class="active-class" class="van-datetime-picker" column-class="column-class" toolbar-class="toolbar-class"></van-picker></uni-shadow-root>
</template>
