    ...
    <uni-shadow-root class="vant-checkbox-index">
        <view class="van-checkbox custom-class">
            <view @click="toggle" class="van-checkbox__icon-wrap">
                ...
                <van-icon :class="utils.bem('checkbox__icon', [shape, { disabled, checked: value }])"
                          ...
                          custom-class="icon-class" custom-style="line-height: 1.25em;" name="success" size="0.8em"
                          v-else></van-icon>
            </view>
            <view :class="'label-class '+(utils.bem('checkbox__label', [labelPosition, { disabled }]))"
                  @click="onClickLabel">
                <slot></slot>
            </view>
        </view>
