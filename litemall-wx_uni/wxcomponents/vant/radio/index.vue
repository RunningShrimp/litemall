<template>
    <uni-shadow-root class="vant-radio-index">
        <view class="van-radio custom-class">
            <view :class="'label-class '+(utils.bem('radio__label', [labelPosition, { disabled }]))"
                  @click="onClickLabel" v-if="labelPosition === 'left'">
                <slot></slot>
            </view>
            ...
            <view :class="'label-class '+(utils.bem('radio__label', [labelPosition, { disabled }]))"
                  @click="onClickLabel" v-if="labelPosition === 'right'">
                <slot></slot>
            </view>
        </view>
    </uni-shadow-root>
