<template>
<uni-shadow-root class="vant-info-index"><view :class="'custom-class van-info '+(utils.bem('info', { dot }))" :style="customStyle" v-if="info !== null && info !== '' || dot">{{ dot ? '' : info }}</view></uni-shadow-root>
</template>
