<template>
    <uni-shadow-root class="vant-slider-index">
        <view :class="'custom-class '+(utils.bem('slider', { disabled }))"
              :style="inactiveColor ? 'background:' + inactiveColor : ''" @click="onClick">
            <view :style="(barStyle)+'; '+(activeColor ? 'background:' + activeColor : '')" class="van-slider__bar">
                <view @touchcancel="onTouchEnd" @touchend="onTouchEnd" @touchmove.stop.prevent="onTouchMove"
                      @touchstart="onTouchStart" class="van-slider__button-wrapper">
