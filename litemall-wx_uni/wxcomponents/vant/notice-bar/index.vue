<template>
    <uni-shadow-root class="vant-notice-bar-index">
        <view :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))"
              :style="'color: '+(color)+'; background-color: '+(backgroundColor)+';'" @click="onClick" v-if="show">
            ...
            <van-icon @click.native.stop.prevent="onClickIcon" class="van-notice-bar__right-icon" name="cross"
