<template>
    <uni-shadow-root class="vant-swipe-cell-index">
        <view @click.stop.prevent="onClick" @touchcancel="endDrag" @touchend="endDrag" @touchmove.capture="onDrag"
              @touchmove.stop.prevent="catchMove ? 'noop' : ''" @touchstart="startDrag" class="van-swipe-cell"
              data-key="cell">
