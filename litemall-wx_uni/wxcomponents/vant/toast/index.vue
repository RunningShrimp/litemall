<template>
<uni-shadow-root class="vant-toast-index"><van-overlay :custom-style="mask ? '' : 'background-color: transparent;'" :show="show" :z-index="zIndex" v-if="mask || forbidClick"></van-overlay>
