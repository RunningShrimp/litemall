<template>
    <uni-shadow-root class="vant-nav-bar-index">
        <view :class="(utils.bem('nav-bar', { fixed }))+' custom-class '+(border ? 'van-hairline--bottom' : '')"
            ...
            <view @click="onClickLeft" class="van-nav-bar__left">
                <block v-if="leftArrow || leftText">
                    <van-icon custom-class="van-nav-bar__arrow" name="arrow-left" size="16px"
                              v-if="leftArrow"></van-icon>
                    <view class="van-nav-bar__text" hover-class="van-nav-bar__text--hover" hover-stay-time="70"
                          v-if="leftText">{{ leftText }}
                    </view>
                </block>
            ...
            <view @click="onClickRight" class="van-nav-bar__right">
                <view class="van-nav-bar__text" hover-class="van-nav-bar__text--hover" hover-stay-time="70"
                      v-if="rightText">{{ rightText }}
                </view>
