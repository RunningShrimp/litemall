...
<uni-shadow-root class="vant-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom">
  <view :class="utils.bem('dropdown-menu__item', { disabled: item.disabled })" :data-index="index" :key="item.index" @click="onTitleTap" v-for="(item,index) in (itemListData)">
...
<wxs module="utils" src="../wxs/utils.wxs"></wxs><wxs module="computed" src="./index.wxs"></wxs>
<script>
