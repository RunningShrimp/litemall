<template>
    <uni-shadow-root class="vant-icon-index">
        <view :class="'custom-class '+(classPrefix)+' '+(isImageName ? 'van-icon--image' : classPrefix + '-' + name)"
              :style="'color: '+(color)+';font-size: '+(utils.addUnit(size))+';'+(customStyle)" @click="onClick">
