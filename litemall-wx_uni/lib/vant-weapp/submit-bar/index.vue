...
<view class="van-submit-bar custom-class">
  ...
  <view :class="'bar-class ' + ( utils.bem('submit-bar__bar', { safe: safeAreaInsetBottom }) )">
    ...
    <van-button :disabled="disabled" :loading="loading" :type="buttonType" @click="onSubmit" class="van-submit-bar__button" custom-class="button-class" size="large" square>{{ loading ? '' : buttonText }}</van-button>
  </view>
</view>
</template>
