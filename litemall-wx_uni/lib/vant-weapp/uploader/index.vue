...
<view class="van-uploader">
  <view class="van-uploader__wrapper">
    ...
    <view :key="index" class="van-uploader__preview" v-for="(item, index) in lists" v-if="previewImage">
      <image :alt="item.name || ('图片' + index)" :data-url="item.url || item.path" :mode="imageFit" :src="item.url || item.path" :style="'width: ' + computedPreviewSize + '; height: ' + computedPreviewSize + ';'" @tap="doPreviewImage" class="van-uploader__preview-image" v-if="item.isImage"></image>
      <view :style="'width: ' + computedPreviewSize + '; height: ' + computedPreviewSize + ';'" class="van-uploader__file" v-else>
      ...
      <van-icon :data-index="index" @tap="deleteItem" class="van-uploader__preview-delete" name="clear" v-if="deletable"></van-icon>
    </view>
    ...
    <block v-if="isInCount">
      ...
      <!-- 默认上传样式 -->
      <view :style="'width: ' + computedPreviewSize + '; height: ' + computedPreviewSize + ';'" @tap="startUpload" class="van-uploader__upload" v-else>
