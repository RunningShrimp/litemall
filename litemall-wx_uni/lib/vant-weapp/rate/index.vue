<template>
    <view @touchmove="onTouchMove" class="van-rate custom-class">
        <view :key="index" :style="'padding-right: ' + ( index !== count - 1 ? gutterWithUnit : '' )"
            ...
            <van-icon :color="disabled ? disabledColor : index + 1 <= innerValue ? color : voidColor"
                      ...
                      :style="'font-size :' + ( size? sizeWithUnit : '')" @click="onSelect" class="van-rate__icon"
            ...
            <van-icon :class="utils.bem('rate__icon', ['half'])"
                      ...
                      :style="'font-size :' + ( size? sizeWithUnit : '')" @click="onSelect" custom-class="icon-class"
