<template>
    <view class="van-circle">
        <canvas :style="style" canvas-id="van-circle" class="van-circle__canvas"></canvas>
...
<script>
    ...
    global['__wxRoute'] = 'lib/vant-weapp/circle/index';
    ...
    export default global['__wxComponents']['lib/vant-weapp/circle/index'];
</script>
<style>
    @import "./index.css";
</style>