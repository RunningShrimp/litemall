<template>
<van-popup :close-on-click-overlay="closeOnClickOverlay" :custom-class="'van-dialog ' + className" :custom-style="( widthWithUnit ? 'width: ' + widthWithUnit + ';' : '' ) + '' + customStyle" :overlay="overlay" :overlay-style="overlayStyle" :show="show" :transition="transition" :z-index="zIndex" @close="onClickOverlay">
