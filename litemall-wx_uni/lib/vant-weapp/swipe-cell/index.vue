<template>
    <view :catchtouchmove="catchMove ? 'noop' : ''" @tap.stop="onClick" @touchcancel="endDrag" @touchend="endDrag"
          @touchstart="startDrag" capture-bind:touchmove="onDrag" class="van-swipe-cell" data-key="cell">
