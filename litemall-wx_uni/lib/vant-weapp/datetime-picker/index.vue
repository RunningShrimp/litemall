<template>
<van-picker :cancel-button-text="cancelButtonText" :columns="columns" :confirm-button-text="confirmButtonText" :item-height="itemHeight" :show-toolbar="showToolbar" :title="title" :visible-item-count="visibleItemCount" @cancel="onCancel" @change="onChange" @confirm="onConfirm" active-class="active-class" class="van-datetime-picker" column-class="column-class" toolbar-class="toolbar-class"></van-picker>
</template>


<script>

global['__wxRoute'] = 'lib/vant-weapp/datetime-picker/index';
...
export default global['__wxComponents']['lib/vant-weapp/datetime-picker/index'];
</script>
<style>
@import "./index.css";
</style>